...
Lemonbot is a chat bot built on the [Hubot][hubot] framework. It was
...
### Running Lemonbot Locally

You can test your hubot by running the following, however some plugins will not
behave as expected unless the [environment variables](#configuration) they rely
upon have been set.

You can start Lemonbot locally by running:
...
Then you can interact with Lemonbot by typing `Lemonbot help`.

    Lemonbot> Lemonbot help
    Lemonbot animate me <query> - The same thing as `image me`, except adds [snip]
    Lemonbot help - Displays all of the help commands that Lemonbot knows about.
    ...
